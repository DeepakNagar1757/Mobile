...
const BalanceCard = ({ summary }: any) => {
  console.log(parseFloat(summary.expense).toFixed(2))
  return (
    <View style={styles.balanceCard}>
      ...
      <View style={styles.balanceStats}>
        ...
        <View style={styles.balanceStatItem}>
          ...
          <Text style={[styles.balanceStatAmount, { color: COLORS.expense }]}>-${Math.abs(parseFloat(summary.expense) || 0).toFixed(2)}</Text>
        </View>
      </View>
    </View>
  )
